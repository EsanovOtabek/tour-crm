...
@section('content')
    ...
    <div
        ...
        <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Yangi kurs qo'shish</h2>
        <form action="{{ route('admin.course.store') }}" enctype="multipart/form-data" method="post">
            ...
            <div class="grid gap-4 sm:grid-cols-2 md:grid-cols-3">
                ...
                <div class="w-full">
                    ...
                    <input type="file" name="image" id="image" class="e-file-input" required>
                </div>
                ...
                <div class="sm:col-span-2 md:col-span-3">
                    ...
                    <textarea id="description" name="description" rows="12"
                              placeholder="Kurs haqida ma'lumot">{{ old('description') }}</textarea>
                </div>
            </div>
            <button type="submit"
